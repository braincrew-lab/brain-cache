---
title: "EnterpriseRAG-Bench: 사내 지식 RAG 벤치마크"
description: "기존 RAG 벤치마크가 위키피디아·웹 같은 공개 데이터에 치우친 문제를 해결하기 위해, 가상의 AI 인프라 회사 \"Redwood Inference\"의 Slack·Gmail·Jira 등 9종 소스 약 50만 문서를 합성 생성한 사내 RAG 벤치마크. 단순 검색부터 문서 간 충돌 해소, 정보 부재 인식까지 10종 실패 모드를 다루는 500개 질문을 포함하며, "
slug: enterpriserag-bench-사내-지식-rag-벤치마크
date: 2026-05-11
authors: [sungyeon]
tags:
  - knowledge-sharing
...
# EnterpriseRAG-Bench: 사내 지식 RAG 벤치마크
...
1. **한국어 환경 적용성**. 코드네임·약어·jargon이라는 발상은 옮겨오기 좋지만, 한국 기업의 결재·보고·메신저 문화는 또 다른 스캐폴딩이 필요할 것이다.
1. **500 질문은 적다**. 카테고리당 10~175개 분포는 통계적 안정성을 흔들 수 있다. 특히 High Level은 10개뿐.
...
## References
- [https://github.com/onyx-dot-app/EnterpriseRAG-Bench](https://github.com/onyx-dot-app/EnterpriseRAG-Bench)
- [https://arxiv.org/abs/2605.05253](https://arxiv.org/abs/2605.05253)
- [https://huggingface.co/spaces/onyx-dot-app/EnterpriseRAG-Bench-Leaderboard](https://huggingface.co/spaces/onyx-dot-app/EnterpriseRAG-Bench-Leaderboard)
